...
CodexDC loads a runtime from the user data directory. That runtime discovers
...
- DOM nodes you inserted outside CodexDC settings pages.
...
CodexDC stores enable flags in `<userRoot>/config.json`.
