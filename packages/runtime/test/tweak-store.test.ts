...
test("normalizeGitHubRepo accepts common GitHub repo forms", () => {
  assert.equal(normalizeGitHubRepo("DOCaCola/CodexDC"), "DOCaCola/CodexDC");
  assert.equal(
    normalizeGitHubRepo("https://github.com/DOCaCola/CodexDC.git"),
    "DOCaCola/CodexDC",
  );
  assert.equal(
    normalizeGitHubRepo("git@github.com:DOCaCola/CodexDC.git"),
    "DOCaCola/CodexDC",
  );
});
